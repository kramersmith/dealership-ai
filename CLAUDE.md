...
- **Models** (`app/models/`) — SQLAlchemy ORM: User, ChatSession, Message, DealState, Vehicle, Deal, Simulation, VehicleDecode, VehicleHistoryReport, VehicleValuation
...
- VIN Assist: chatStore detects VINs in user messages, triggers VinInterceptModal for inline decode/confirm flow. VinAssistCard renders in-chat VIN decode results.
