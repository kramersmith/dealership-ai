...
- Buyer context (researching, reviewing_deal, at_dealership) drives static fallback quick actions, dashboard panel ordering, system prompt preamble, and hardcoded greeting messages
