...
- **Positive:** Partial UPDATE statements are clean and efficient — `UPDATE deal_states SET their_offer = 34000 WHERE session_id = ?` touches only one field.
