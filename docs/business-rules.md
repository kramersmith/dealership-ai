...
**Note:** Dashboard panel ordering is now data-driven via `getPanelWidgets()` in InsightsPanel, which shows/hides widgets based on available deal data rather than buyer context. See the InsightsPanel section in the PRD for details.
