...
# Hardcoded scenarios for MVP — will move to DB later
SCENARIOS = [
    {
        "id": "scenario-1",
        ...
        "ai_persona": {
            ...
            "challenges": ["Has a lower offer from competitor", "Focused on OTD price", "Asks for fee breakdown"],
        },
    },
    {
        "id": "scenario-2",
        ...
        "ai_persona": {
            ...
            "challenges": ["Thinks trade-in worth $5k more", "Gets upset if car dismissed", "Needs to feel respected"],
        },
    },
    {
        "id": "scenario-3",
        ...
        "ai_persona": {
            ...
            "challenges": ["Pre-approved at 4.9%", "Knows GAP costs $300 via insurance", "Calls out pressure tactics"],
        },
    },
    {
        "id": "scenario-4",
        ...
        "ai_persona": {
            ...
            "challenges": ["Already walked once", "Won't respond to urgency", "Values time over saving $500"],
        },
    },
]
