...
/** Scoped buyer chat — slate-950 base, emerald primary, purple accents (Stitch-aligned). */
export const darkCopilotTheme = {
  ...darkTheme,
  background: palette.copilotBackground,
  backgroundStrong: palette.copilotSurfaceSolid,
  backgroundHover: 'rgba(51, 65, 85, 0.85)',
  backgroundPress: 'rgba(51, 65, 85, 0.95)',
  backgroundFocus: 'rgba(51, 65, 85, 0.85)',
  color: '#f8fafc',
  colorHover: '#f8fafc',
  colorPress: '#e2e8f0',
  colorFocus: '#f8fafc',
  borderColor: 'rgba(255, 255, 255, 0.1)',
  borderColorHover: palette.copilotEmerald,
  borderColorFocus: palette.copilotEmerald,
  borderColorPress: 'rgba(255, 255, 255, 0.14)',
  placeholderColor: '#94a3b8',
  shadowColor: 'rgba(0, 0, 0, 0.45)',
  shadowColorHover: 'rgba(0, 0, 0, 0.55)',
  color1: palette.copilotBackground,
  color2: palette.copilotSurfaceSolid,
  color3: '#334155',
  color4: '#475569',
  color5: '#64748b',
  color6: '#94a3b8',
  color7: '#cbd5e1',
  color8: '#e2e8f0',
  color9: palette.copilotEmerald,
  color10: palette.copilotEmeraldPressed,
  color11: '#e2e8f0',
  color12: '#f8fafc',
  brand: palette.copilotEmerald,
  brandPressed: palette.copilotEmeraldPressed,
  brandLight: '#6ee7b7',
